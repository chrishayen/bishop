 ...
 * @returns str - Lowercase hex string of the hash
 * @example
 * import crypto;
 ...
 * @returns str - Decoded string (empty if invalid)
 * @example
 * import crypto;
 ...
 * @returns str - UUID in format xxxxxxxx-xxxx-5xxx-yxxx-xxxxxxxxxxxx
 * @example
 * import crypto;
 * id := crypto.uuid_v5("myapp", "user123");
 */
 ...
 * @returns List<u8> - List of random bytes
 * @example
 * import crypto;
...
unique_ptr<Program> create_crypto_module() {
    ...
    // fn random_bytes(int count) -> List<u8>
