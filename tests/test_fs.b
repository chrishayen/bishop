...
fn test_write_file() -> void or err {
...
fn test_append_file() -> void or err {
...
fn test_write_bytes() -> void or err {
...
fn test_file_handle_open_close() -> void or err {
...
fn test_file_handle_read_all() -> void or err {
...
fn test_file_handle_with_statement() -> void or err {
...
fn test_file_handle_read_line() -> void or err {
...
fn test_file_handle_read_lines() -> void or err {
...
fn test_file_handle_write() -> void or err {
...
fn test_file_handle_write_line() -> void or err {
...
fn test_file_handle_append_mode() -> void or err {
...
fn test_list_dir() -> void or err {
    files := fs.list_dir("tests") or fail err;
    assert_eq(true, files.length() > 0);
}

fn test_mkdir_and_remove_dir() -> void or err {
...
fn test_remove_all() -> void or err {
