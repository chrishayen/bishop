...
fn test_run_simple_command() -> void or err {
...
fn test_run_ls_command() -> void or err {
...
fn test_run_with_multiple_args() -> void or err {
...
fn test_run_command_not_found() -> void or err {
...
fn test_run_command_exit_code() -> void or err {
...
fn test_shell_command_substitution() -> void or err {
...
fn test_env_read_existing() -> void or err {
    home := process.env("HOME") or fail err;
    assert_eq(true, home.length() > 0);
}

fn test_env_read_nonexistent_fails() -> void or err {
...
fn test_env_with_or_handler() -> void or err {
...
fn test_set_env_empty_name_fails() -> void or err {
...
fn test_cwd_returns_path() -> void or err {
    current := process.cwd() or fail err;
    assert_eq(true, current.length() > 0);
}

fn test_chdir_success() -> void or err {
...
fn test_chdir_failure() -> void or err {
...
fn test_cwd_with_or_handler() -> void or err {
...
fn test_spawn_simple_echo() -> void or err {
...
fn test_spawn_multiple_lines() -> void or err {
...
fn test_spawn_stderr() -> void or err {
...
fn test_spawn_exit_code() -> void or err {
...
fn test_spawn_with_goroutine() -> void or err {
